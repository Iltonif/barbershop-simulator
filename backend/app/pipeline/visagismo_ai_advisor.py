...
def build_user_message(client: ClientProfile) -> str:
    ...
    lineas = [
        ...
        _campo("Simetría ocular", _get(p, "anatomical_metrics", "facial_features_profile", "eye_symmetry")),
        _campo("Uso de gafas", _get(p, "anatomical_metrics", "facial_features_profile", "has_glasses")),
        _campo("Otras irregularidades observadas", _get(p, "anatomical_metrics", "facial_features_profile", "detected_anomalies_notes")),
        "",
        "## Pelo",
